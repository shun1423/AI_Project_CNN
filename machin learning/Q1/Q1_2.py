...
class Q1_2_model(nn.Module):
    def __init__(self):
        super(Q1_2_model, self).__init__()
...
def main():
    ...
    epochs = 40
    batch = 32
    net = Q1_2_model().to(device)
    criterion = nn.CrossEntropyLoss()
    optimizer = optim.AdamW(net.parameters(), lr=learning_rate)


    best_valid_acc = None
    FILEPATH = './checkpoint_Q1_2.pth'
    epoch_loss_list = []
    epoch_acc_list = []
    valid_loss_list = []
    valid_acc_list = []
